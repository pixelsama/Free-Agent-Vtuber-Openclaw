...
const MESSAGES = {
  [LANGUAGE_ZH_CN]: {
    ...
    'voice.mockCommitHint': '当前 commit 使用测试音频片段打通链路；下一阶段会替换为真实麦克风 PCM 数据。',
    'voice.status': '状态',
    'voice.captureOn': '采集中',
  ...
  [LANGUAGE_EN_US]: {
    ...
    'voice.mockCommitHint': 'Commit currently uses a synthetic audio chunk to verify the chain. Next phase will replace it with real microphone PCM input.',
    'voice.status': 'Status',
